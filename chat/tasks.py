...
def handle_puzzle_solved(puzzle_id, answer_text):
    ...
    try:
        ...
        requests.patch(f"https://discord.com/api/channels/{hunt.settings.discord_puzzle_announcements_channel_id}", headers=chat_service._headers, json={"name": party_count_channel(party_count)}, timeout=5)
